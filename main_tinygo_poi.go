...
func main() {
	...
	// os.Args = []string{"tinygo_stub", "-gpio_led_data=0", "-led_count=50", "-direct_start", "-no_gui", "-fps=250", "-led_order=GRB", "-picture_mode"}
	// os.Args = []string{"tinygo_stub", "-gpio_led_data=0", "-led_count=50", "-direct_start", "-no_gui", "-fps=250", "-led_type=APA102", "-picture_mode"}

	os.Args = []string{"tinygo_stub", "-gpio_led_data=0", "-led_count=58", "-direct_start", "-no_gui", "-fps=250", "-picture_mode", "-led_order=GRB"}
	//Arduino Nano
